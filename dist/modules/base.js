import { BotcastError, BotcastAuthError, BotcastPaymentRequiredError, BotcastSubscriptionExpiredError, BotcastRateLimitError, BotcastValidationError, BotcastNotFoundError, } from '../errors.js';
    ...
    async request(options) {
        ...
        while (attempts < maxAttempts) {
            ...
            try {
                ...
                if (err instanceof BotcastAuthError ||
                ...
                if (attempts >= maxAttempts) {
                    ...
                    throw new BotcastError(err.name === 'AbortError'
